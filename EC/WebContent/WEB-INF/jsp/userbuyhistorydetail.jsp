				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table>
							...
							<tbody>
								<tr>
									<td class="center">${userHistory.formatDate}</td>
									<td class="center">${userHistory.deliveryMethodName}</td>
									<td class="center">${userHistory.totalPrice }円</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
								<c:forEach var="item" items="${itemHistoryList}">
								<tr>
								...
								<tr>
									<td class="center">${userHistory.deliveryMethodName}</td>
									<td class="center">${userHistory.deliveryMethodPrice}円</td>
								</tr>
							</tbody>
						</table>
					</div>
